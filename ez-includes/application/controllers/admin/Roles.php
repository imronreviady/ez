...
class Roles extends Admin_Controller {
  ...
  function index()
  {
    ...
    $data['page_title'] = ez_line('roles_page_name');
  ...
  function edit($id=null)
  {
    ...
    $data['page_title'] = ez_line('roles_'.$data['action'].'_page_name');
  ...
  public function delete_multi ()
  {
    ...
    if(is_demo() == FALSE) {
      ...
      $this->session->set_flashdata('message', ez_line('deleted', $this->lang->line('roles') ));
      redirect('admin/roles');
    } else {
        // Set successfully flashdata
        $this->session->set_flashdata('error', 'This option not work in demo site.');
