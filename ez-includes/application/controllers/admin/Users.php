...
class Users extends Admin_Controller {
  ...
  function index()
  {
    ...
    $data['page_title'] = ez_line('users_page_name');
  ...
  function edit($id=null)
  {
    ...
    $data['page_title'] = ez_line('users_'.$data['action'].'_page_name');
    // Load manage permissions view
    $this->load->ext_view('admin', 'layouts/main', $data);
  }
  ...
  public function delete_multi ()
  {
    ...
    if(is_demo() == FALSE) {
      ...
      $this->session->set_flashdata('message', ez_line('deleted', $this->lang->line('users') ));
      redirect('admin/users');
    } else {
        // Set successfully flashdata
        $this->session->set_flashdata('error', 'This option not work in demo site.');
