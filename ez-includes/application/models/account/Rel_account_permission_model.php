...
class Rel_account_permission_model extends CI_Model {
  ...
  function get()
  {
    return $this->db->get('ez_rel_account_permission')->result();
  }
  ...
  function get_by_account_id($account_id)
  {
    ...
    $this->db->from('ez_rel_account_permission');
    $this->db->join('ez_acl_permission', 'ez_rel_account_permission.permission_id = ez_acl_permission.id');
    $this->db->where("ez_rel_account_permission.account_id = $account_id AND ez_acl_permission.suspendedon IS NULL");
  ...
  function update($account_id, $permission_id)
  {
    ...
    {
      $this->db->insert('ez_rel_account_permission', array('account_id' => $account_id, 'permission_id' => $permission_id));
    }
  }
  ...
  {
    $this->db->delete('ez_rel_account_permission', array('account_id' => $account_id, 'permission_id' => $permission_id));
  }
  ...
  {
    $this->db->delete('ez_rel_account_permission', array('account_id' => $account_id));
  }
  ...
  {
    $this->db->delete('ez_rel_account_permission', array('permission_id' => $permission_id));
  }
}