...
$config = array(
	...
	*/
	...
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://http://github.com/imronreviady/ez',
	...
	*/
	...
	|
	*/
	'current_path' => '../../../../ez-content/uploads/',
	...
	|
	*/
	'thumbs_base_path' => '../../../../ez-content/thumbs/',
	...
	*/
	...
	'fixed_path_from_filemanager'             => array( '../../../../ez-content/thumbs/', '../../../../ez-content/thumbs/', '../../../../ez-content/thumbs/', '../../../../ez-content/thumbs/' ), //fixed path of the image folder from the current position on upload folder
