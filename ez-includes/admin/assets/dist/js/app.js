...
$(function () {
  ...
  $("#datatable").each(function() {
    var dt = $(this).DataTable({
        ...
        'render': function(data, type, full, meta) {
          ...
          return '<div class="pretty info smooth"><input type="checkbox" name="id[]" value="' + $('<div/>').text(data).html() + '"><label><i class="fa fa-check"></i></label></div>';
        }
      }],
      'order': [[0, 'asc']]
    });
  ...
  // Select2
  $('select').not('#datatable_length label select, .not').each(function() {
    $(this).select2({
        placeholder: $(this).data('placeholder') || false,
        placeholder: $(this).data('tags') || false
    });
  });
  ...
  if (o.navbarMenuSlimscroll && typeof $.fn.slimscroll != 'undefined') {
    $(".navbar .menu, .control-sidebar-tabs .tab-content").slimscroll({
