...
function bs_media_body( $atts, $content = null ) {
  ...
  register_shortcode_css(array(
    base_url('ez-content/themes/ez/assets/css/font-awesome.min.css'), 
    base_url('ez-content/themes/nova/assets/css/main.css'),
    base_url('ez-content/themes/nova/assets/css/bootstrap.min.css')
  ));