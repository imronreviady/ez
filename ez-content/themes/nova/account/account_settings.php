...
<div class="control-group <?php echo (form_error('settings_email') || isset($settings_email_error)) ? 'error' : ''; ?>">
    <label class="control-label span3" for="settings_email"><?php echo lang('settings_email'); ?></label>

    <div class="span9">
		<?php echo form_input(array('class' => 'input-xlarge','name' => 'settings_email', 'id' => 'settings_email', 'value' => set_value('settings_email') ? set_value('settings_email') : (isset($account->email) ? $account->email : ''), 'maxlength' => 160)); ?>
...
<div class="control-group <?php echo (form_error('settings_fullname')) ? 'error' : ''; ?>">
    <label class="control-label span3" for="settings_fullname"><?php echo lang('settings_fullname'); ?></label>

    <div class="span9">
		<?php echo form_input(array('class' => 'input-xlarge','name' => 'settings_fullname', 'id' => 'settings_fullname', 'value' => set_value('settings_fullname') ? set_value('settings_fullname') : (isset($account_details->fullname) ? $account_details->fullname : ''), 'maxlength' => 160)); ?>
...
<div class="control-group <?php echo (form_error('settings_firstname')) ? 'error' : ''; ?>">
    <label class="control-label span3" for="settings_firstname"><?php echo lang('settings_firstname'); ?></label>

    <div class="span9">
		<?php echo form_input(array('class' => 'input-xlarge','name' => 'settings_firstname', 'id' => 'settings_firstname', 'value' => set_value('settings_firstname') ? set_value('settings_firstname') : (isset($account_details->firstname) ? $account_details->firstname : ''), 'maxlength' => 80)); ?>
...
<div class="control-group <?php echo (form_error('settings_lastname')) ? 'error' : ''; ?>">
    <label class="control-label span3" for="settings_lastname"><?php echo lang('settings_lastname'); ?></label>

    <div class="span9">
		<?php echo form_input(array('class' => 'input-xlarge','name' => 'settings_lastname', 'id' => 'settings_lastname', 'value' => set_value('settings_lastname') ? set_value('settings_lastname') : (isset($account_details->lastname) ? $account_details->lastname : ''), 'maxlength' => 80)); ?>
...
<div class="control-group <?php echo isset($settings_dob_error) ? 'error' : ''; ?>">
    <label class="control-label span3" for="settings_dateofbirth"><?php echo lang('settings_dateofbirth'); ?></label>
...
<div class="control-group <?php echo (form_error('settings_gender')) ? 'error' : ''; ?>">
    <label class="control-label span3" for="settings_gender"><?php echo lang('settings_gender'); ?></label>
...
<div class="control-group <?php echo (form_error('settings_postalcode')) ? 'error' : ''; ?>">
    <label class="control-label span3" for="settings_postalcode"><?php echo lang('settings_postalcode'); ?></label>

    <div class="span9">
		<?php echo form_input(array('class' => 'input-xlarge','name' => 'settings_postalcode', 'id' => 'settings_postalcode', 'value' => set_value('settings_postalcode') ? set_value('settings_postalcode') : (isset($account_details->postalcode) ? $account_details->postalcode : ''), 'maxlength' => 40, 'class' => 'input-small')); ?>
...
<div class="control-group <?php echo (form_error('settings_country')) ? 'error' : ''; ?>">
    <label class="control-label span3" for="settings_country"><?php echo lang('settings_country'); ?></label>
