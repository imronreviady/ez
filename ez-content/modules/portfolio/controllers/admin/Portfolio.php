...
class Portfolio extends Admin_Controller {
    ...
    public function index()
    {
      	...
      	$data['page_title'] = ez_line('portfolio') . ' <span class="badge bg-aqua">' . count_table('posts', array('post_type' => 'portfolio')) . '</span>';
    ...
    public function _create_watermark($fileName)
    {
        ...
        $config['wm_overlay_path']  = './ez-content/uploads/watermark.png'; //the overlay image
